...
avarage_score_of_each_person.update({students[0]: average_score1, students[1]: average_score2, students[2]: average_score3, students[3]: average_score4, students[4]: average_score5})
